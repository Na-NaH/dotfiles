...
--Changes are recommended to be made in the script-opts directory.
	...
	linux_copy = 'xsel -b', --copy command that will be used in Linux. OR write a different command
	linux_paste = 'xsel -ob', --paste command that will be used in Linux. OR write a different command
